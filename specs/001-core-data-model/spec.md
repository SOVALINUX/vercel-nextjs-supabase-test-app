...
| **User**        | [/domain/user/user.md](/domain/user/user.md)                             | Authenticated identity. Has a name, unique email, a single role, and an active status.                                        |
| **Role**        | [/domain/role/role.md](/domain/role/role.md)                             | Named permission profile. Seeded at launch: `super_admin` and `account_manager`.                                              |
| **Client**      | [/domain/client/client.md](/domain/client/client.md)                     | Business organisation. Carries a name, link, and references to sales executive, account manager, and account representatives. |
| **Employee**    | [/domain/employee/employee.md](/domain/employee/employee.md)             | Internal staff member (supply side). Name, email, job title, department, and active status.                                   |
| **Opportunity** | [/domain/opportunity/opportunity.md](/domain/opportunity/opportunity.md) | Open demand item linked to a client. Title, role needed, quantity, start date, and status enum.                               |
